...
public class NewsReaderActivity extends FragmentActivity
    ...
    // add in joo-kyuu practice
    private Stack<Integer> backStackAtDualPane = new Stack<Integer>();
    ...
    public void onHeadlineSelected(int index) {
        ...
        if (mIsDualPane) {
            ...
            if(currentIndex != index) {
                backStackAtDualPane.push(Integer.valueOf(index));
                currentIndex = index;
            }
        }
        else {
    ...
    public void onBackPressed() {
        if(!backStackAtDualPane.isEmpty()) {
            int backIndex = backStackAtDualPane.pop().intValue();
            if (currentIndex == backIndex) {
                backIndex = backStackAtDualPane.pop().intValue();
            }
            mArticleFragment.displayArticle(mCurrentCat.getArticle(backIndex));
